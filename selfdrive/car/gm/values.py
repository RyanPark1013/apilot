...
CAR_INFO: Dict[str, Union[GMCarInfo, List[GMCarInfo]]] = {
  ...
  CAR.TRAX: GMCarInfo("Chevrolet CHEVROLET_TRAX"),
}
...
CAMERA_ACC_CAR = {CAR.BOLT_EUV, CAR.SILVERADO, CAR.EQUINOX, CAR.VOLT_CC, CAR.BOLT_CC, CAR.TRAX}
